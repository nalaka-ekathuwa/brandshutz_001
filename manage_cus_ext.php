                                    ...
                                    <form action="control/cus_ext_process.php?action=<?php echo $action; ?>" method="post" enctype= multipart/form-data >
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="bj" type="number" class="form-control" id="build" min="1850" max="2500"  value="<?php echo isset($_GET['key'])?$row['bj']:''; ?>" >
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="checked_on" type="date" class="form-control" id="checked_on" placeholder="checked_on" value="<?php echo isset($_GET['key'])?$row['checked_on']:''; ?>" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="next_check">Next Check</label>
                                                <input name="next_check" type="date" class="form-control" id="next_check" value="<?php echo isset($_GET['key'])?$row['next_check']:''; ?>">
                                            </div>
                                        </div> 
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
