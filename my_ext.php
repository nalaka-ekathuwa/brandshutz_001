                            ...
                            <div class="table-responsive">
                                <table class="table table-hover e-commerce-table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT c.`id`, `ext_id`, `serial_no`, `bj`,  `cus_id`, `damage`, `gps`, `checked_on`, `next_check`, `test_interval`,e.image FROM `ext_customer` c JOIN extinguisher e ON c.ext_id=e.id WHERE c.cus_id =$sesssion_uid";
                                        //echo $sql;
                                        $conn = $GLOBALS['con'];
